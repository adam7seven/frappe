                ...
                for (; a && ((a = 0), c[0] && (i = 0)), i; )
                    try {
                        ...
                        switch (((r = 0), o && (c = [2 & c[0], o.value]), c[0])) {
                            ...
                            default:
                                if (
                                    !((o = i.trys), (o = o.length > 0 && o[o.length - 1]) || (6 !== c[0] && 2 !== c[0]))
                                ) {
                                    i = 0;
                                    continue;
                                }
        ...
        n(this, void 0, void 0, function () {
            ...
            return t(this, function (t) {
                switch (t.label) {
                    ...
                    case 1:
                        return c < e.length
                            ? ((n[c] = r(e[c], c)), (u = Date.now()) >= i + a ? ((i = u), [4, o(0)]) : [3, 3])
                            : [3, 4];
                    case 2:
                        t.sent(), (t.label = 3);
                    case 3:
...
function Y() {
    ...
    return (
        g([
            ...
            "MozAppearance" in
                (null !== (n = null === (e = document.documentElement) || void 0 === e ? void 0 : e.style) &&
                void 0 !== n
                    ? n
                    : {}),
                ...
                for (
                    ...
                    switch (s[0]) {
                        ...
                        case "[":
                            ...
                            u(
                                d[1],
                                null !== (t = null !== (n = d[4]) && void 0 !== n ? n : d[5]) && void 0 !== t ? t : ""
                            );
                            break;
                        default:
                            throw new Error(r);
    ...
    return n(this, void 0, void 0, function () {
        ...
        return t(this, function (t) {
            switch (t.label) {
                case 0:
                    for (
                        n = document, a = n.createElement("div"), i = new Array(e.length), c = {}, B(a), s = 0;
                        s < e.length;
                        ++s
                    )
        ...
        return "MacIntel" === e && x() && !F()
            ? (function () {
                  ...
                  var e = screen,
                      n = e.width / e.height;
                  return (
                      g(["MediaSource" in window, !!Element.prototype.webkitRequestFullscreen, n > 0.65 && n < 1.53]) >=
                      2
                  );
              })()
                ? "iPad"
