	...
	*/
    ...
    function getColors($e) {
        ...
        if (!backcolor) {
            ...
            if (frontcolorcomponents) {
                if (
                    Math.max.apply(null, [frontcolorcomponents.r, frontcolorcomponents.g, frontcolorcomponents.b]) > 127
                ) {
    ...
    function Vector(x, y) {
        ...
        this.angleTo = function (vectorB) {
            ...
            if (divisor === 0) {
                ...
                return (
                    Math.acos(Math.min(Math.max((this.x * vectorB.x + this.y * vectorB.y) / divisor, -1.0), 1.0)) /
                    Math.PI
                );
            }
        };
		...
		*/
        ...
        function _setDrawingData(data, formattype) {
            ...
            if (!importplugins.hasOwnProperty(formattype)) {
                throw new Error(
                    apinamespace + " is unable to find import plugin with for format '" + String(formattype) + "'"
                );
