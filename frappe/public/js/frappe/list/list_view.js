...
frappe.views.ListView = class ListView extends frappe.views.BaseList {
    ...
    get_like_html(doc) {
        ...
        div.appendChild(this._element_factory.get_like_element(doc.name, is_liked, liked_by, title));
    ...
    get_subject_element(doc, title) {
        ...
        div.appendChild(ellipsisSpan).appendChild(
            ef.get_link_element(doc.name, this.get_form_link(doc), this.get_subject_text(doc, title))
        );
