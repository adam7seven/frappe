<template>
	<div>
		<div>
			<img ref="image_ref" :src="src" :alt="file.id" />
		</div>
		<div class="image-cropper-actions">
			...
			<div>
				<button class="btn btn-sm margin-right" @click="emit('toggle_image_cropper')"
...
<script setup>
	...
	function crop_image() {
		...
		canvas.toBlob((blob) => {
			var cropped_file_obj = new File([blob], props.file.id, {
				type: blob.type,
			});
