...
frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
    ...
    get_visible_columns() {
        const visible_column_names = this.datatable.datamanager
            .getColumns(true)
            .map((col) => col.id);

        return visible_column_names
    ...
    get_menu_items() {
        let items = [
            ...
            },
            {
                ...
                action: () =>
                    frappe.set_route("List", "Auto Email Report", { report: this.report_id }),
                standard: true,
            },
            {
                label: __("Add Column"),
