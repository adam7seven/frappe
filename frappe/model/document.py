...
class Document(BaseDocument):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if args and args[0]:
            if isinstance(args[0], str):
                ...
                self.id = self.doctype if len(args) == 1 else args[1]
    ...
    def __repr__(self):
        ...
        return f"<{doctype}: {id}{docstatus}{parent}>"
...
@frappe.whitelist()
def unlock_document(doctype: str | None = None, id: str | None = None, args=None):
    # Backward compatibility
    if not doctype and not id and args:
