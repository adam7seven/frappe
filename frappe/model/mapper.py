...
def get_mapped_doc(
    ...
    if not target_doc:
        ...
        if table_maps[from_doctype].get("on_parent"):
            ...
            target_doc = frappe.new_doc(target_doctype, parent_doc=target_parent, parentfield=target_parentfield)
...
def map_fields(source_doc, target_doc, table_map, source_parent):
    no_copy_fields = set(
        [d.fieldname for d in source_doc.meta.get("fields") if (d.no_copy == 1 or d.fieldtype in table_fields)]
