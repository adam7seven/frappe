...
@frappe.whitelist()
def make_mapped_doc(method, source_id, selected_children=None, args=None):
...
@frappe.whitelist()
def map_docs(method, source_ids, target_doc, args=None):
    ...
    for src in json.loads(source_ids):
