...
def flt(s: NumericType | str | None, precision: int | None = None, rounding_method: str | None = None) -> float:
...
def comma_sep(some_list: list | tuple, pattern: str, add_quotes=True) -> str:
    ...
    if isinstance(some_list, list | tuple):
        ...
        if not some_list:
            ...
            some_list = ["'{}'".format(s) for s in some_list] if add_quotes else ["{}".format(s) for s in some_list]
