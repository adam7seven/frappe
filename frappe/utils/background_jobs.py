...
def enqueue(
    ...
    **kwargs,
    ...
    :param job_id: [DEPRECATED] can be used to name an enqueue call, which can be used to prevent
    duplicate calls
...
def execute_job(site, method, event, job_id, kwargs, user=None, is_async=True, retry=0):
...
def start_worker(
    ...
    with frappe.init_site():
        ...
        queues = get_queue_list(queue, build_queue_id=True)
...
def get_worker_id(queue):
    ...
    if queue:
        # hostname.pid is the default worker id
