...
def insert_values_for_multiple_docs(all_contents):
    values = [
        "({doctype}, {id}, {content}, {published}, {title}, {route})".format(**content) for content in all_contents
    ]
    batch_size = 50000
...
def search(text, start=0, limit=20, doctype=""):
    ...
    for word in set(text.split("&")):
        ...
        query = (
            ...
            .select(global_search.doctype, global_search.id, global_search.content, rank)
