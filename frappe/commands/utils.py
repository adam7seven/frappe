...
@pass_context
def export_doc(context, doctype, docid):
...
@click.argument("doctype")
@click.argument("path")
@click.option("--id", help="Export only one document")
@pass_context
def export_json(context, doctype, path, id=None):
...
@click.argument("path")
@pass_context
def bulk_reid(context, doctype, path):
