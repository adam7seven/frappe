...
def restore_backup(
    ...
    if not Path(sql_file_path).exists():
        click.secho(f"File {sql_file_path} not found. Trying to check in alternative directories.", fg="yellow")
        for dir in dirs:
...
@pass_context
def reinstall(context: CliCtxObj, admin_password=None, db_root_username=None, db_root_password=None, yes=False):
