...
class TestWebForm(IntegrationTestCase):
    ...
    def test_edit(self):
        ...
        self.assertNotEqual(frappe.db.get_value("Event", self.event_id, "description"), doc.get("description"))
    ...
    def test_webform_html_meta_is_added(self):
        ...
        self.assertIn(self.normalize_html('<meta property="og:title" content="Test Meta Form Title">'), content)
        self.assertIn(
