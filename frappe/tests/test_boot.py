    ...
    def test_get_user_pages_or_reports_with_permission_query(self):
        ...
        frappe.get_doc(
            dict(
                ...
                id="test_report_permission_query",
        ...
        allowed_reports = frappe.cache.get_value(
            "has_role:Report", user=frappe.session.user
        )
