...
class TestDynamicLinks(FrappeTestCase):
    ...
    def test_delete_normal(self):
        ...
        self.assertFalse(frappe.db.exists("Email Unsubscribe", unsub.id))
    ...
    def test_delete_with_comment(self):
        ...
        self.assertTrue(
            frappe.get_all(
                "Comment",
                filters={"reference_doctype": "Event", "reference_id": event.id},
            )
        )
        event.delete()
        self.assertFalse(
    ...
    def test_custom_fields(self):
        ...
        add_custom_field("Event", "test_ref_id", "Dynamic Link", "test_ref_doc")
