...
class TestRenameDoc(IntegrationTestCase):
    ...
    def test_parenttype(self):
        ...
        parent_a = new_doctype(fields=[table_field], allow_rename=1, autoid="Prompt").insert()
        parent_b = new_doctype(fields=[table_field], allow_rename=1, autoid="Prompt").insert()
