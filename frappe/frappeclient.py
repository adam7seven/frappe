...
class FrappeClient:
    ...
    def setup_key_authentication_headers(self):
        if self.api_key and self.api_secret:
            ...
            if self.frappe_authorization_source:
                auth_source = {
                    "Frappe-Authorization-Source": self.frappe_authorization_source
                }
    ...
    def update(self, doc):
        ...
        """
        url = (
            self.url + "/api/resource/" + doc.get("doctype") + "/" + cstr(doc.get("id"))
        )
    ...
    def delete(self, doctype, id):
        ...
        return self.post_request(
            {"cmd": "frappe.client.delete", "doctype": doctype, "id": id}
        )
    ...
    def reid_doc(self, doctype, old_id, new_id):
        """Reid remote document
