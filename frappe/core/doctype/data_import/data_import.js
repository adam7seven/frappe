        ...
        frappe.call({
            ...
            callback: function (r) {
                ...
                if (frm.doc.import_type === "Insert New Records") {
                    message = __("Successfully imported {0} out of {1} records.", [successful_records, total_records]);
                } else {
                    message = __("Successfully updated {0} out of {1} records.", [successful_records, total_records]);
                }

                if (failed_records > 0) {
                    message += "<br/>" + __("Please click on 'Export Errored Rows', fix the errors and import again.");
                }
