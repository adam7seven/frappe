...
def make(
    ...
    **kwargs,
    ...
    if kwargs:
        ...
        warn(
            f"Options {kwargs} used in frappe.core.doctype.communication.email.make " "are deprecated or unsupported",
...
def validate_email(doc: "Communication") -> None:
    ...
    if doc.communication_type != "Communication" or doc.communication_medium != "Email" or doc.flags.in_receive:
        return
