...
class DocType(Document):
    ...
    def get_permission_log_options(self, event=None):
        if self.custom and event != "after_delete":
            return {"fields": ("permissions", {"fields": ("fieldname", "ignore_user_permissions", "permlevel")})}
                    ...
                    if fname.endswith(".js"):
                        ...
                        file_content = re.sub(
                            ...
                            lambda x: (
                                ...
                                else new_no_space_no_hyphen if x.group() == old_no_space_no_hyphen else new_no_space
                            ),
                            code,
                        )
