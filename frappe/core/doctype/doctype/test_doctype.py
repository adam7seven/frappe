...
class TestDocType(IntegrationTestCase):
    ...
    def test_sync_field_order(self):
        ...
        path = get_file_path(
            test_doctype.module, test_doctype.doctype, test_doctype.name
        )
        ...
        try:
            ...
            test_doctype.append(
                "fields",
                {"label": "Field 5", "fieldname": "field_5", "fieldtype": "Data"},
            )
    ...
    def test_links_table_fieldname_validation(self):
        ...
        doc.append(
            "links",
            {"link_doctype": "User", "link_fieldname": "a_field_that_does_not_exists"},
        )
    ...
    def test_autoincremented_doctype_transition(self):
        ...
        dt = new_doctype("testy_autoinc_dt", autoname="autoincrement").insert(
        ...
        dt_data = frappe.get_doc(
            {"doctype": dt.name, "some_fieldname": "test data"}
