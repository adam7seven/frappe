...
class TestDocShare(IntegrationTestCase):
    ...
    def test_share_disabled_add(self):
        ...
        self.assertFalse(self.event.has_permission("share"))
        self.assertRaises(frappe.PermissionError, frappe.share.add, "Event", self.event.id, "test1@example.com")
    ...
    def test_share_disabled_add_with_ignore_permissions(self):
        ...
        frappe.share.add_docshare("Event", self.event.id, "test1@example.com", flags={"ignore_share_permission": True})
