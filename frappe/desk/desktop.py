        ...
        if frappe.has_permission("Number Card", throw=False):
            ...
            for number_card in number_cards:
                if frappe.has_permission("Number Card", doc=number_card.number_card_name):
                    # Translate label
                    number_card.label = _(number_card.label) if number_card.label else _(number_card.number_card_name)
...
def get_workspace_sidebar_items():
    ...
    return {
        "workspace_setup_completed": frappe.db.get_single_value("Workspace Settings", "workspace_setup_completed"),
        "pages": pages,
