...
class UserProfile {
    ...
    render_percentage_chart(field, title) {
        frappe
            .xcall("frappe.desk.page.user_profile.user_profile.get_energy_points_percentage_chart_data", {
                user: this.user_id,
                field: field
            })
            .then(chart => {
    ...
    get_user_points() {
        return frappe
            .xcall("frappe.social.doctype.energy_point_log.energy_point_log.get_user_energy_and_review_points", {
                user: this.user_id
            })
            .then(r => {
                if (r[this.user_id]) {
