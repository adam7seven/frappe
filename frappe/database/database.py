...
class Database:
    ...
    def sql(
        ...
        *,
        ...
        try:
            ...
            if not (
                ignore_ddl and (self.is_missing_column(e) or self.is_table_missing(e) or self.cant_drop_field_or_key(e))
            ):
                raise
    ...
    def _log_query(
        ...
        if frappe.conf.allow_tests and frappe.conf.developer_mode and frappe.cache.get_value("flag_print_sql"):
        ...
        if unmogrified_query and is_query_type(unmogrified_query, ("alter", "drop", "create", "truncate", "rename")):
            _query = _query or str(mogrified_query)
    ...
    def log_query(self, query: str, values: QueryValues = None, debug: bool = False, explain: bool = False) -> str:
    ...
    def set_single_value(
        ...
        *,
        ...
        frappe.db.delete("Singles", filters={"field": ("in", tuple(to_update)), "doctype": doctype}, debug=debug)
