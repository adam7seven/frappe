...
class GoogleOAuth:
    ...
    def __init__(self, domain: str, validate: bool = True):
        ...
        self.scopes = (
            " ".join(_SCOPES[self.domain]) if isinstance(_SCOPES[self.domain], list | tuple) else _SCOPES[self.domain]
        )
    ...
    def authorize(self, oauth_code: str) -> dict[str, str | int]:
        ...
        data = {
            ...
            "client_secret": self.google_settings.get_password(fieldname="client_secret", raise_exception=False),
