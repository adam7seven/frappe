...
def enqueue_webhook(doc, webhook) -> None:
    ...
    try:
        ...
        log_request(webhook.id, doc.id, request_url, headers, data)
        return
    ...
    for i in range(3):
        try:
            ...
            log_request(webhook.id, doc.id, request_url, headers, data, r)
            break
...
@frappe.whitelist()
def get_all_queues():
    """Fetches all workers and returns a list of available queue ids."""
