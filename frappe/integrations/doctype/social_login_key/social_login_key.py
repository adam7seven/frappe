...
class SocialLoginKey(Document):
    ...
    def get_social_login_provider(self, provider, initialize=False):
        ...
        providers["Facebook"] = {
            ...
            "api_endpoint_args": json.dumps({"fields": "first_name,last_name,email,gender,location,verified,picture"}),
            "auth_url_data": json.dumps({"display": "page", "response_type": "code", "scope": "email,public_profile"}),
        }
