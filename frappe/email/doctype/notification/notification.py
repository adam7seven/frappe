    ...
    def validate(self):
        ...
        if self.event in ("Minutes Before", "Minutes After"):
            ...
            if self.minutes_offset < 10:
                frappe.throw(_("Please specify at least 10 minutes due to the trigger cadence of the scheduler"))
...
"""
    ...
    def get_list_of_recipients(self, doc, context):
        ...
        for recipient in self.recipients:
            ...
            if recipient.receiver_by_document_field:
                data_field, child_field = _parse_receiver_by_document_field(recipient.receiver_by_document_field)
                if child_field:
    ...
    def get_attachment(self, doc):
        ...
        if (doc.docstatus == 0 and not print_settings.allow_print_for_draft) or (
            ...
            frappe.throw(
                _("""Not allowed to attach {0} document, please enable Allow Print For {0} in Print Settings""").format(
                    status
                ),
