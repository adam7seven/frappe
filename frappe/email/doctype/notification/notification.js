...
frappe.notification = {
    setup_fieldname_select: function (frm) {
        ...
        frappe.model.with_doctype(frm.doc.document_type, function () {
                ...
                let extract_receiver_field = function (df) {
                    ...
                    if (frappe.model.table_fields.includes(df.fieldtype)) {
                        ...
                        return $.map(child_fields, function (cdf) {
                            return is_receiver_field(cdf) ? get_select_options(cdf, df.fieldname) : null;
                        });
                    } else {
            ...
            frm.set_df_property("date_changed", "options", get_date_change_options(["Date", "Datetime"]));
            frm.set_df_property("datetime_changed", "options", get_date_change_options(["Datetime"]));
