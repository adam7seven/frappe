...
class EmailAccount(Document):
    ...
    def validate(self):
        ...
        if not frappe.local.flags.in_install and not self.awaiting_password and not self.service == "Frappe Mail":
    ...
    def _frappe_mail_client(self):
        if self.auth_method == "OAuth":
            ...
            frappe.throw(
                _("Please Authorize OAuth for Email Account {0}").format(frappe.bold(self.email_account_name)),
