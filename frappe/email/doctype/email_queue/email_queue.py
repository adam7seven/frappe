...
@task(queue="short")
@deprecated
def send_mail(email_queue_id, smtp_server_instance: SMTPServer = None):
...
class SendMailContext:
    ...
    def get_tracker_str(self, recipient_email) -> str:
        ...
        if self.queue_doc.get("email_read_tracker_url"):
            ...
            tracker_url = get_url(
                f"{email_read_tracker_url}?{get_signed_params(params)}"
            )
...
class QueueBuilder:
            ...
            unsubscribed = (
                ...
                .where(
                    ...
                    & (
                        (
                            (
                                EmailUnsubscribe.reference_doctype
    ...
    def as_dict(self, include_recipients=True):
        email_account = self.get_outgoing_email_account()
        email_account_id = (
            email_account and email_account.is_exists_in_db() and email_account.id
        )
        ...
        d = {
            ...
            "email_account": email_account_id or None,
