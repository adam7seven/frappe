                ...
                frappe.call({
                    ...
                    callback: function () {
                        ...
                        if (cint(frappe.sys_defaults.suspend_email_queue)) {
                            frappe.show_alert(
                                __("Email queue is currently suspended. Resume to automatically send other emails.")
                            );
                        }
                    },
                });
            ...
            frm.add_custom_button("Retry Sending", function () {
                frm.call({
                    ...
                    callback: function () {
                        frm.reload_doc();
                        frappe.show_alert({
                            message: __("Status Updated. The email will be picked up in the next scheduled run."),
                            indicator: "green",
                        });
                    },
                });
