...
class OAuthWebRequestValidator(RequestValidator):
    ...
    def validate_redirect_uri(self, client_id, redirect_uri, request, *args, **kwargs):
        ...
        redirect_uris = (
            cstr(frappe.db.get_value("OAuth Client", client_id, "redirect_uris")).strip().split(get_url_delimiter())
        )
    ...
    def validate_code(self, client_id, code, client, request, *args, **kwargs):
        ...
        if code in [vcode["id"] for vcode in validcodes]:
            ...
            code_challenge_method = frappe.db.get_value("OAuth Authorization Code", code, "code_challenge_method")
