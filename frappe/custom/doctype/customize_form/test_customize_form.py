...
class TestCustomizeForm(FrappeTestCase):
    ...
    def test_fetch_to_customize(self):
        ...
        self.assertEqual(
            d.get("fields", {"fieldname": "event_type"})[0].in_list_view, 1
        )
    ...
    def test_set_allow_on_submit(self):
        ...
        self.assertEqual(
            d.get("fields", {"fieldname": "subject"})[0].allow_on_submit or 0, 0
        )
    ...
    def test_custom_action(self):
        ...
        d = self.get_customize_form("Event")
        d.append(
            "actions", dict(label="Test Action", action_type="Route", action=test_route)
        )
        d.run_method("save_customization")
    ...
    def test_change_to_autoincrement_autoid(self):
        d = self.get_customize_form("Event")
        d.autoid = "autoincrement"
    ...
    def test_system_generated_fields(self):
        ...
        custom_field = frappe.get_doc(
            "Custom Field", {"dt": doctype, "fieldname": custom_field_name}
        )
        ...
        self.assertEqual(
            frappe.db.get_value("Property Setter", property_setter_filters, "value"),
            "Test Description",
        )
    ...
    def test_custom_field_order(self):
        ...
        field_order_property = json.loads(
            frappe.db.get_value(
                "Property Setter",
                {"doc_type": "ToDo", "property": "field_order"},
                "value",
            )
        )
        ...
        self.assertEqual(
            ...
            [df.fieldname for df in frappe.get_meta("ToDo").fields],
        )
