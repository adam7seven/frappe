context("Workspace 2.0", () => {
    ...
    it("Create Private Page", () => {
        ...
        cy.get('.sidebar-item-container[item-title="Test Private Page"]').should("have.attr", "item-public", "0");
        cy.wait(300);
    ...
    it("Create Child Page", () => {
        ...
        // check if sidebar item is added in pubic section
        cy.get('.sidebar-item-container[item-title="Test Child Page"]').should("have.attr", "item-public", "0");
        cy.wait(300);
        cy.get('.standard-actions .btn-primary[data-label="Save"]').click();
        cy.wait(300);
        cy.get('.sidebar-item-container[item-title="Test Child Page"]').should("have.attr", "item-public", "0");
